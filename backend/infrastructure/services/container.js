...
const container = {
  ...
  publishTrack:        makePublishTrack({ trackRepository, audioService }),      // ← audioService не null!
  archiveTrack:        makeArchiveTrack({ trackRepository }),
  deleteTrack:         makeDeleteTrack({ trackRepository, fileStorage }),        // ← fileStorage не null!
